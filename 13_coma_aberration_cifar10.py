"""
13_coma_aberration_cifar10.py
============================================
Coma Aberration -- 3x3 PD Kernel [CIFAR-10]
Run: python 13_coma_aberration_cifar10.py
"""
...
def parse_args():
    p=argparse.ArgumentParser(description='Coma PDK -- CIFAR-10')
    ...
    p.add_argument('--res-dir',      type=str,   default='./res/coma_cifar10')
    return p.parse_args()
