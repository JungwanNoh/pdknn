"""
13_coma_aberration_bsd500.py
============================================
Coma Aberration -- 3x3 PD Kernel [BSD500]
Run: python 13_coma_aberration_bsd500.py
"""
...
def parse_args():
    p=argparse.ArgumentParser(description='Coma PDK -- BSD500')
    ...
    p.add_argument('--res-dir',      type=str,   default='./res/coma_bsd500')
    return p.parse_args()
