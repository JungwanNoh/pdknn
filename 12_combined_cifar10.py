"""
12_combined_cifar10.py
============================================
PSF blur + Vignetting -- 3x3 PD Kernel [CIFAR-10]
...
Run:
  python 12_combined_cifar10.py
  python 12_combined_cifar10.py --sigma0 0.3 --alpha-psf 1.2 --alpha-vig 2.5
  python 12_combined_cifar10.py --data-dir /path/to/CIFAR-10
"""
...
def parse_args():
    p=argparse.ArgumentParser(description='PSF+Vignetting PDK -- CIFAR-10')
    ...
    p.add_argument('--res-dir',   type=str,   default='./res/combined_cifar10')
    return p.parse_args()
