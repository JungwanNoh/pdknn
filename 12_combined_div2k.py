"""
12_combined_div2k.py
============================================
PSF blur + Vignetting -- 3x3 PD Kernel [DIV2K]
...
Run:
  python 12_combined_div2k.py
  python 12_combined_div2k.py --sigma0 0.3 --alpha-psf 1.2 --alpha-vig 2.5
  python 12_combined_div2k.py --data-dir /path/to/DIV2K
"""
...
def parse_args():
    p=argparse.ArgumentParser(description='PSF+Vignetting PDK -- DIV2K')
    ...
    p.add_argument('--res-dir',   type=str,   default='./res/combined_div2k')
    return p.parse_args()
