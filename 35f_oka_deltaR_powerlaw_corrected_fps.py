...
"""
35f_oka_deltaR_powerlaw_corrected_fps.py
======================================================================
...
def make_comparison_scheme_table(args, out_csv, out_png):
    rows = [
        ...
        ("Programming step", "-", "Discrete PGM states from measured LTD data; full measured pulse range if N-budget=0"),
        ("Programming energy", "-", "Σ 1/2 C_gate V_PGM^2 N_pulse, counted per single frame"),
...
def parse_args():
    ...
    p.add_argument("--res-dir", default="./res/oka35f_deltaR_powerlaw_corrected_fps")
    return p.parse_args()
...
def main():
    ...
    e_oka_lab_pJ = e_pgm_frame_pJ + e_read_lab_pJ + e_oka_adc_pJ + e_oka_sram_pJ
    e_oka_fast_pJ = e_pgm_frame_pJ + e_read_fast_pJ + e_oka_adc_pJ + e_oka_sram_pJ
    ...
    summary_path = os.path.join(args.res_dir, "35f_summary.csv")
