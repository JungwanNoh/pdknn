"""
14_non_uniform_illum_div2k.py
============================================
Non-uniform Illumination -- 3x3 PD Kernel [DIV2K]
Run: python 14_non_uniform_illum_div2k.py
"""
...
def parse_args():
    p=argparse.ArgumentParser(description='Non-uniform Illum PDK -- DIV2K')
    ...
    p.add_argument('--res-dir',       type=str,   default='./res/nonunif_div2k')
    return p.parse_args()
