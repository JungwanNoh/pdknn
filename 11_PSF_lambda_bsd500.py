...
11_PSF_bsd500.py
============================================
Position-dependent PSF blur only -- 3x3 PD Kernel [BSD500]
...
Run:
  python 11_PSF_bsd500.py
  python 11_PSF_bsd500.py --sigma0 0.3 --alpha-psf 1.2 --n-iter 500
"""
...
def parse_args():
    p=argparse.ArgumentParser(description='PSF only PDK -- BSD500')
    ...
    p.add_argument('--res-dir',   type=str,   default='./res/psf_only_bsd500')
    return p.parse_args()
